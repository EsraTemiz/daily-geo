    ...
    <div>
      <div className='fixed inset-0 bg-black/50 flex items-center justify-center'>
         ...
         <div className='bg-white max-w-2xl p-8 rounded-2xl flex flex-col gap-4'>
          <h3>{gununSorusu.title}</h3>
          <img  src={gununSorusu.image}/>
          <p>{gununSorusu.hints[steps]}</p>
            {steps < gununSorusu.hints.length -1 && (<button className=" bg-purple-400 self-start rounded p-2" onClick={()=>setStep(steps+1)}>ipuçları</button> )}
         </div>
