...
const GununSorusuModal = ({onClose,image,hints,title,solutionImage,topic ,bugununTarihi}) => {
  return (
    <div>
      <div className='fixed inset-0 bg-black/50 flex items-center justify-center'>
         ...
         <div className='bg-white max-w-4xl p-8 rounded-2xl flex flex-col gap-2'>
            ...
            <SoruAnalizi  title={title} image={image} solutionImage={solutionImage} hints={hints} topic={topic}  bugununTarihi/>
